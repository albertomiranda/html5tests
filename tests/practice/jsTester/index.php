<?php 
    ...
    foreach($dirContent as $dirName){
        ...
        $samplesNav.="\t\t\t\t<option value='$dirName'>$dirName</option>\n";
    }
?>
<!doctype html>
<html lang="en">
    ...
    <body>
        ...
        <section>
            <div class="codeBox">
                <textarea id="code" type="text" class="code"></textarea>
            </div>
            <input type="button" value="Execute" onclick="DefaultTest.execute('code')" />
        </section>
