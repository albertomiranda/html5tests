window.onload = function() {
    ...
    function generateWorld() {
        ...
        for(var i = 0; i < COLUMNS; i++) {
            ...
            for(var j = 0; j < ROWS; j++) {
                var grassType = Crafty.randRange(1, 4);
    ...
    Crafty.scene("main", function() {
        ...
        Crafty.c('Avatar', {
            ...
            init: function() {
                //setup animations
                this.requires("2D, Canvas, Collision, solid, Controls")
            ...
            makeAvatar : function(name, upFrames, downFrames, rightFrames, leftFrames) {
            	this.name = name;
            	
            	this.requires("SpriteAnimation")
            		.animate("walk_left", leftFrames[0], leftFrames[1], leftFrames[2])
            		.animate("walk_right", rightFrames[0], rightFrames[1], rightFrames[2])
            		.animate("walk_up", upFrames[0], upFrames[1], upFrames[2])
            		.animate("walk_down", downFrames[0], downFrames[1], downFrames[2]);
        ...
        var player1 = Crafty.e("Avatar, player1")
	        .attr({
	            x: 160, 
	            y: 144, 
	            z: 1
	        ...
	        .leftControls(1)
	        .makeAvatar("Hero", [0,3,2], [0,0,2], [0,2,2], [0,1,2]);

        var player2 = Crafty.e("Avatar, player2")
	        .attr({
	            x: 460, 
	            y: 144, 
	            z: 1
	        ...
	        .rightControls(2)
	        .makeAvatar("Anti-hero", [2,0,2], [2,0,2], [8,0,8], [0,0,0]);     
    });
};